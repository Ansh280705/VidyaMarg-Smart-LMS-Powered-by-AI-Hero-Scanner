...
function StudentViewCoursesPage() {
  ...
  async function fetchAllStudentViewCourses(filters, sort) {
    ...
    const filtered = demoCourses.filter((c) => {
      return (
        (!filters.category ||
          (filters.category && filters.category.includes(c.category))) &&
        (!filters.level ||
          (filters.level && filters.level.includes(c.level))) &&
        (!filters.primaryLanguage ||
          (filters.primaryLanguage &&
            filters.primaryLanguage.includes(c.primaryLanguage)))
      );
    });
    setStudentViewCoursesList(filtered);
